...
To install ``RadGEEToolbox`` version 1.7.2 using pip (recommended: use a virtual environment)::
...
To install ``RadGEEToolbox`` version 1.7.2 using conda-forge (recommended: use a virtual environment)::
