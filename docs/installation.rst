...
To install ``RadGEEToolbox`` version 1.6.5 using pip (recommended: use a virtual environment)::
...
To install ``RadGEEToolbox`` version 1.6.5 using conda-forge (recommended: use a virtual environment)::
